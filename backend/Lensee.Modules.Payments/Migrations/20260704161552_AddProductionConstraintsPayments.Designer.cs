...
namespace Lensee.Modules.Payments.Migrations
{
    ...
    [Migration("20260704161552_AddProductionConstraintsPayments")]
    partial class AddProductionConstraintsPayments
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("installment_sub_logs", "payments", t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_sub_log_payment_method", "payment_method is null or payment_method in ('CashTransaction','CashHandToHand','BankTransfer','Wallet')");
