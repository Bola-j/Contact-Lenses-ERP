...
namespace Lensee.Modules.Payments.Migrations
{
    ...
    [Migration("20260911124828_AllowMerchantAccountPaymentMethod")]
    partial class AllowMerchantAccountPaymentMethod
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("merchant_refund_reservations", "payments", t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_merchant_refund_reservation_status", "status in ('PendingApproval','Approved','Paid','Rejected','Cancelled')");
                        });
                });
